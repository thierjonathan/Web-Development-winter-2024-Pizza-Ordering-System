...
class bestellung extends Page
{
    ...
    protected function generateView():void
    {
        ...
        $ordered_articles_ids = [1, 2];

        $ordered_articles = [];
        foreach ($data as $article) {
            if (in_array($article['article_id'], $ordered_articles_ids)) {
                $ordered_articles[] = [
...
//<input type="button" value="Auswahl löschen" onclick="discardSelection()">
    ...
    protected function processReceivedData():void
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['address']) && isset($_POST['ordered_articles'])) {
            ...
            if (!isset($_SESSION['all_ordering_id']) || !is_array($_SESSION['all_ordering_id'])) {
                $_SESSION['all_ordering_id'] = [];
            }
