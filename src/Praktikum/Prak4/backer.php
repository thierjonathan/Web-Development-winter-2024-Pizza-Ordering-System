            ...
            foreach($data as $value){
                ...
                foreach ($value['ordered_articles'] as $key => $article){
                    ...
                    if(!$pizzaIsWithDriver){
                        ...
                        <p>Change Status:</p>
                        <form method="post" id="changeStatus" action="backer.php">
                            ...
                            <label for="bestelltButton_{$article['ordered_article_id']}">Bestellt</label><br>

                            <input type="radio" id="imOfenButton_{$article['ordered_article_id']}" name="status" value="1"
                                onclick="this.form.submit();">
                            <label for="imOfenButton_{$article['ordered_article_id']}">Im Ofen</label><br>

                            <input type="radio" id="fertigButton_{$article['ordered_article_id']}" name="status" value="2"
                                onclick="this.form.submit();">
                            <label for="fertigButton_{$article['ordered_article_id']}">Fertig</label><br>
                        </form>
